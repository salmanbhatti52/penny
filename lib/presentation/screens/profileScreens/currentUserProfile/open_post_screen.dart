...
class OpenPostScreen extends StatefulWidget {
  final int index;
  const OpenPostScreen({super.key, required this.index});

  @override
  State<OpenPostScreen> createState() => OpenPostScreenState();
}

class OpenPostScreenState extends State<OpenPostScreen> {
  loadData() async {
