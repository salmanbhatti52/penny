...
class OtherUserPost extends StatefulWidget {
  final String userID;
  final int index;
  const OtherUserPost({super.key, required this.index, required this.userID});

  @override
  State<OtherUserPost> createState() => OtherUserPostState();
}

class OtherUserPostState extends State<OtherUserPost> {
  loadData() async {
    ...
    Provider.of<OpenPostProvider>(context, listen: false)
        .getAllPost(userID!, widget.index);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Consumer<OpenPostProvider>(
            builder: (context, openPostProvider, child) {
              final data = openPostProvider.openProfilePostModel.data;

              return Expanded(
                  child: openPostProvider.isLoading
                      ? const Center(child: CircularProgressIndicator())
                      : openPostProvider.openProfilePostModel.data != null
                          ? RefreshIndicator(
                              onRefresh: () => openPostProvider.refreshData(
                                  userID!, widget.index),
                                                    ...
                                                    child:
                                                      ...
                                                      onSelected: (String
                                                        ...
                                                        if (result ==
                                                          ...
                                                          CustomToast.show(
                                                              "This Place Reported to admin successfully",
                                                              Colors.green);
                                                        }
                                                      },
  ...
  void _showBottomSheet(
      BuildContext context, int index, OpenPostProvider openPostProvider) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ConstrainedBox(
                    ...
                    child: openPostProvider.openProfilePostModel.data![index]
                                .reviews.isEmpty ??
                            true
                        ? const Center(
                            child: Text(
                        ...
                        : ListView.builder(
                            itemCount: openPostProvider.openProfilePostModel
                                    .data![index].reviews.length ??
                                0,
                            itemBuilder: (context, reviewIndex) {
                              final review = openPostProvider
                              ...
                              return _buildComment(
                                ...
                                openPostProvider.openProfilePostModel
                                        .data![index].palaceId
                                        .toString() ??
                                    '',
                  ...
                  Row(
                    children: <Widget>[
                            ...
                            showModalBottomSheet(
                                ...
                                builder: (BuildContext bc) {
                                  return _showReviewBottomSheet(
                                      context, index, openPostProvider);
                                });
                          },
                          child: Container(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          _addReview(context, index, 2.4, openPostProvider);
                        },
                      ),
                    ],
                  ),
  ...
  void _addReview(BuildContext context, int index, double rating,
      OpenPostProvider openPostProvider) async {
